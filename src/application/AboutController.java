...
public class AboutController implements Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		descLabelTwo.setText(
				"With the aid of a heuristic guide, our Knight moves only to coordinates that are least accessible first. "
						+ "This ensures areas that are hard to reach will be visited first. "
						+ "You can reset the board and start the tour from a new location during/after a tour. Have fun testing it with different starting positions!");
